...
namespace CUS.Areas.Admin.Controllers
{
    public class HistoriaPsicologiaController : Controller
    {
        ...
        public ActionResult Familia(Models.hc_PS_Familia HistoriaClinica, string expediente)
        {
            try
            {
                ...
                if (paciente != null)
                {
                    ...
                    var hcHecha = (from a in hcMed.hc_PS_Familia
                    ...
                    if (hcHecha != null)
                    {
                        hcMed.Database.ExecuteSqlCommand("DELETE FROM hc_PS_Familia WHERE Id= '" + hcHecha.Id + "';");
                    }
        ...
        public ActionResult AtencionPsi(AtencionPsicologicaPropiedades HistoriaClinica, string expediente)
        {
            try
            {
                ...
                if (paciente != null)
                {
                    ...
                    //Buscamos si la 'Id_claveHC' que se insertará ya existe en la tabla de la hc
                    var hcHecha = (from a in hcMed.hc_PS_AtencionPsicologica
                                   where a.Clave_hc_px == Id_claveHC
                                   where a.Id_Paciente == paciente.Id
                                   select a).FirstOrDefault();
                    ...
                    if (hcHecha != null)
                    {
                        hcMed.Database.ExecuteSqlCommand("DELETE FROM hc_PS_AtencionPsicologica WHERE Id= '" + hcHecha.Id + "';");
                    }
        ...
        public ActionResult Motivo(Models.hc_PS_MotivoConsulta HistoriaClinica, string expediente)
        {
            try
            {
                ...
                if (paciente != null)
                {
                    ...
                    //Buscamos si la 'Id_claveHC' que se insertará ya existe en la tabla de la hc
                    var hcHecha = (from a in hcMed.hc_PS_MotivoConsulta
                                   where a.Clave_hc_px == Id_claveHC
                                   where a.Id_Paciente == paciente.Id
                                   select a).FirstOrDefault();
                    ...
                    if (hcHecha != null)
                    {
                        hcMed.Database.ExecuteSqlCommand("DELETE FROM hc_PS_MotivoConsulta WHERE Id= '" + hcHecha.Id + "';");
                    }
        ...
        public ActionResult Sintomatologia(SintomatologiaActualPropiedades HistoriaClinica, string expediente)
        {
            try
            {
                ...
                if (paciente != null)
                {
                    ...
                    //Buscamos si la 'Id_claveHC' que se insertará ya existe en la tabla de la hc
                    var hcHecha = (from a in hcMed.hc_PS_SintomatologiaActual
                                   where a.Clave_hc_px == Id_claveHC
                                   where a.Id_Paciente == paciente.Id
                                   select a).FirstOrDefault();
                    ...
                    if (hcHecha != null)
                    {
                        hcMed.Database.ExecuteSqlCommand("DELETE FROM hc_PS_SintomatologiaActual WHERE Id= '" + hcHecha.Id + "';");
                    }
        ...
        public ActionResult AreasAtencion(AreasAtencionPropiedades HistoriaClinica, string expediente)
        {
            try
            {
                ...
                if (paciente != null)
                {
                    ...
                    //Buscamos si la 'Id_claveHC' que se insertará ya existe en la tabla de la hc
                    var hcHecha = (from a in hcMed.hc_PS_AreasAtencion
                                   where a.Clave_hc_px == Id_claveHC
                                   where a.Id_Paciente == paciente.Id
                                   select a).FirstOrDefault();
                    ...
                    if (hcHecha != null)
                    {
                        hcMed.Database.ExecuteSqlCommand("DELETE FROM hc_PS_AreasAtencion WHERE Id= '" + hcHecha.Id + "';");
                    }
        ...
        public ActionResult SignosAlarma(Models.hc_PS_SignosAlarma HistoriaClinica, string expediente)
        {
            try
            {
                ...
                if (paciente != null)
                {
                    ...
                    //Buscamos si la 'Id_claveHC' que se insertará ya existe en la tabla de la hc
                    var hcHecha = (from a in hcMed.hc_PS_SignosAlarma
                                   where a.Clave_hc_px == Id_claveHC
                                   where a.Id_Paciente == paciente.Id
                                   select a).FirstOrDefault();
                    ...
                    if (hcHecha != null)
                    {
                        hcMed.Database.ExecuteSqlCommand("DELETE FROM hc_PS_SignosAlarma WHERE Id= '" + hcHecha.Id + "';");
                    }
        ...
        public ActionResult DiagnosticoPres(DiagnosticoPresPropiedades HistoriaClinica, string expediente)
        {
            try
            {
                ...
                if (paciente != null)
                {
                    ...
                    //Buscamos si la 'Id_claveHC' que se insertará ya existe en la tabla de la hc
                    var hcHecha = (from a in hcMed.hc_PS_DiagnosticoPres
                                   where a.Clave_hc_px == Id_claveHC
                                   where a.Id_Paciente == paciente.Id
                                   select a).FirstOrDefault();
                    ...
                    if (hcHecha != null)
                    {
                        hcMed.Database.ExecuteSqlCommand("DELETE FROM hc_PS_DiagnosticoPres WHERE Id= '" + hcHecha.Id + "';");
                    }
        ...
        public ActionResult IndicacionTera(Models.hc_PS_IndicacionTerapeutica HistoriaClinica, string expediente)
        {
            try
            {
                ...
                if (paciente != null)
                {
                    ...
                    //Buscamos si la 'Id_claveHC' que se insertará ya existe en la tabla de la hc
                    var hcHecha = (from a in hcMed.hc_PS_IndicacionTerapeutica
                                   where a.Clave_hc_px == Id_claveHC
                                   where a.Id_Paciente == paciente.Id
                                   select a).FirstOrDefault();
                    ...
                    if (hcHecha != null)
                    {
                        hcMed.Database.ExecuteSqlCommand("DELETE FROM hc_PS_IndicacionTerapeutica WHERE Id= '" + hcHecha.Id + "';");
                    }
        ...
        [HttpPost]
        public ActionResult Otros(Models.hc_PS_Otros HistoriaClinica, string expediente)
        {
            try
            {
                var fecha = DateTime.Now.ToString("yyyy-MM-ddTHH:mm:ss");
                ...
                if (paciente != null)
                {
                    ...
                    //Buscamos si la 'Id_claveHC' que se insertará ya existe en la tabla de la hc
                    var hcHecha = (from a in hcMed.hc_PS_Otros
                                   where a.Clave_hc_px == Id_claveHC
                                   where a.Id_Paciente == paciente.Id
                                   select a).FirstOrDefault();
                    ...
                    if (hcHecha != null)
                    {
                        hcMed.Database.ExecuteSqlCommand("DELETE FROM hc_PS_Otros WHERE Id= '" + hcHecha.Id + "';");
                    }

                    //Se crea la HC de esta sección/pestaña
                    Models.hc_PS_Otros Historia = new Models.hc_PS_Otros();
                    ...
                    Historia.Id_Paciente = paciente.Id;
                    Historia.Clave_hc_px = Id_claveHC;
                    hcMed.hc_PS_Otros.Add(Historia);
                    hcMed.SaveChanges();
                }
                return Json(new { MENSAJE = "Succe: " }, JsonRequestBehavior.AllowGet);
            }
            ...
            try
            {
                ...
                string query =
                    ...
                    "O.Interconsulta, O.PadecimientoActual, O.Especifica_PadecimientoActual, O.ProximaCita " +
                                    ...
                                    "LEFT JOIN hc_PS_Otros O ON O.Clave_hc_px = HCli.Clave_hc_px " +
